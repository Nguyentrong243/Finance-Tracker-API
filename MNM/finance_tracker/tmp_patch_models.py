...
old = """    frequency = models.CharField(max_length=20, choices=FREQUENCY_CHOICES)
...
new = """    frequency = models.CharField(max_length=20, choices=FREQUENCY_CHOICES, default='monthly')
    wallet = models.CharField(max_length=100, default='Ví chính', blank=True)
    notes = models.TextField(blank=True, null=True)
    start_date = models.DateField()
    end_date = models.DateField(null=True, blank=True)
